...
# constants
token = '1530461455:AAE_yelQhh4EiZ3s90eqg__aysuEOsVgD10'
link = 'https://api.telegram.org/bot1530461455:AAE_yelQhh4EiZ3s90eqg__aysuEOsVgD10/getMe'
# get updates
link = 'https://api.telegram.org/bot1530461455:AAE_yelQhh4EiZ3s90eqg__aysuEOsVgD10/getUpdates'
# send messages
message = 'https://api.telegram.org/bot1530461455:AAE_yelQhh4EiZ3s90eqg__aysuEOsVgD10/sendMessage?chat_id=810309611&text=Hi Will'
...
def send_message(chat_id, text):
    ...
    print('Status code Send Message: {}'.format(r.status_code))
...
def predict(data):
    # API call
    url = 'https://rossman-model-analogic.herokuapp.com/rossmann/predict'
    ...
    if request.method == 'POST':
        ...
        if store_id != 'error':
            ...
            if data != 'error':
                d1 = predict(data)
                # calculation
                d2 = d1[['store', 'prediction']].groupby(
